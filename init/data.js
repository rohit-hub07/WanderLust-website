const sampleListings = [
  ...
  {
    title: "Glamorous Beachfront Villa",
    description:
      "Indulge in luxury in this glamorous beachfront villa with a private pool and direct beach access.",
  ...
  },
  {
    ...
    description:
      "Relax in this cozy seaside cottage with stunning ocean views and a charming garden.",
  ...
  },
  {
    ...
    description:
      "Live like royalty in this luxurious mansion featuring a private pool, expansive gardens, and top-notch amenities.",
    image: "https://images.unsplash.com/photo-1526045478516-99145907023c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmVhY2glMjB2aWxsYXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
    price: 8000,
  ...
  },
  {
    ...
    description:
      "Enjoy breathtaking sea views from the balcony of this modern seaside apartment, just steps away from the beach.",
    image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D",
    price: 2500,
    location: "Barcelona",
    country: "Spain",
  },
  {
    ...
    description:
      "Experience the romance of Paris in this charming apartment located in the heart of the city.",
    image: "https://images.pexels.com/photos/240526/pexels-photo-240526.jpeg?auto=compress&cs=tinysrgb&w=600",
    price: 2200,
    location: "Paris",
    country: "France",
  },
  {
    ...
    description:
      "Reconnect with nature in this eco-friendly jungle lodge, offering sustainable accommodations in a lush tropical setting.",
